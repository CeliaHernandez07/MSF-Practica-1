...
plt.plot(t,u1,"-",color = [92/255,179/255,56/255], label = "Pao(t)")
ts,PA = ctrl.forced_response(sys,t,u1,x0)
plt.plot(t,PA,"-",color = [251/255,65/255,65/255], label = "PA(t)")
_,VPID = ctrl.forced_response(sysPID,t,u1,x0)
plt.plot(t,VPID,":",linewidth=3, color = [0/255,107/255,255/255], label = "VPID(t)")
...
fig2 = plt.figure();
plt.plot(t,u2,"-",color = [92/255,179/255,56/255], label = "Pao(t)")
...
plt.plot(t,u3,"-",color = [92/255,179/255,56/255], label = "Pao(t)")
...
plt.plot(t,u4,"-",color = [92/255,179/255,56/255], label = "Pao(t)")
ts,PA = ctrl.forced_response(sys,t,u4,x0)
plt.plot(t,PA,"-",color = [251/255,65/255,65/255], label = "PA(t)")
_,VPID = ctrl.forced_response(sysPID,t,u4,x0)
plt.plot(t,VPID,":",linewidth=3, color = [0/255,107/255,255/255], label = "VPID(t)")
plt.xlim(-0.25,10);plt.xticks(np.arange(0,11,1.0))
plt.ylim(-1.1,1.2); plt.yticks(np.arange(-1.1,1.2,0.2))
plt.xlabel("t[s]",fontsize=11)
plt.ylabel("V_i(t)",fontsize=11)
plt.legend(bbox_to_anchor=(0.5,-0.3),loc="center",ncol=3,fontsize=8,frameon=False)
plt.show()
